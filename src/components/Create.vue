<template>
    <div id="create">
        <div class="col-md-6 col-md-offset-3">
            <form v-on:submit.prevent='createForm' class="form-horizontal" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="radio">
                            <label><input type="radio" v-model="employee.gender" value="1" name="gender">Male</label>
                        </div>
                        <div class="radio">
                            <label><input type="radio" v-model='employee.gender' value="2" name="gender">Female</label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="file" v-on:change="onFileChange" class="form-control" id="image" name="image">
                    </div>
                </div>
                <div class="form-group">
